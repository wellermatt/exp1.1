...
opt.between.chains.correlations = TRUE
...
if (opt.within.chains.correlations == TRUE) f_cor.within.chains()

if (opt.between.chains.correlations == TRUE) f_cor.between.chains()